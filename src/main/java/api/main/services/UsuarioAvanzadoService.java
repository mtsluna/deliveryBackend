...
public class UsuarioAvanzadoService {
	...
	/**
	 * This method transform all entities 'UsuarioAvanzado' in 'UsuarioAvanzadoDTO' in the database
	 * @return entities 'UsuarioAvanzado' transformed in 'UsuarioAvanzado'DTO (Data transference Object)
	 * @since 1.0
	 */
	...
	/**
	 * This method transform an entity 'UsuarioAvanzado' in 'UsuarioAvanzadoDTO' in the database
	 * @return entity 'UsuarioAvanzado' transformed in 'UsuarioAvanzadoDTO' (Data transference Object)
	 * @since 1.0
	 */
	...
	/**
	 * This method transform an entity 'UsuarioAvanzadoDTO' in the entity 'UsuarioAvanzado' for save it in the database
	 * @param usuarioAvanzadoDTO it is an object DTO that comes from controller that will transformed in an entity
	...
	/**
	 * This method transform an entity 'UsuarioAvanzadoDTO' in the entity 'UsuarioAvanzado' for update it in the database
	...
	/**
	 * This method call the repository for delete an entity 'UsuarioAvanzado' in the database for the id.
